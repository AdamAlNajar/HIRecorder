...
UPDATE:
- WE ARE CURRENLTY IN ALPHA 2
 which allows you to record system audio 
 we also reworked the UI a little bit
 we also improved the video performance a little bit :)

How to use:
1 - Select screen/Tab to record 
2 - Click on Share (it's recording button)
3 - Click on hide, when you see the menu (optional)
4 - Recording System audio:
	when you are prompted to record, 
	you will see a switch saying "Record System/Tab audio" depending on what you are recording
	click the switch, and thats it!
